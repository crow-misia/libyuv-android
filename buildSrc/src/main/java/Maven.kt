object Maven {
    ...
    const val issueTrackerUrl = "https://github.com/crow-misia/libyuv-android/issues"
    const val gitUrl = "https://github.com/crow-misia/libyuv-android.git"
    const val githubRepo = "crow-misia/libyuv-android"
    const val licenseName = "The Apache Software License, Version 2.0"
    const val licenseUrl = "http://www.apache.org/licenses/LICENSE-2.0.txt"
    const val licenseDist = "repo"
    val labels = arrayOf("android", "libyuv")
