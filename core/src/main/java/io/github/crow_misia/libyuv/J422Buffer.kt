...
class J422Buffer private constructor(
    ...
    companion object Factory : BufferFactoryYUV<J422Buffer>, CapacityCalculator<Plane3Capacities> {
        ...
        override fun allocate(width: Int, height: Int, cropRect: Rect): J422Buffer {
        ...
        override fun wrap(buffer: ByteBuffer, width: Int, height: Int, cropRect: Rect): J422Buffer {
        ...
        override fun wrap(planeY: Plane, planeU: Plane, planeV: Plane, width: Int, height: Int, cropRect: Rect): J422Buffer {
            return J422Buffer(
                buffer = null,
                planeY = planeY,
                planeU = planeU,
