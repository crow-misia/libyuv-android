...
class Argb4444Buffer private constructor(
    ...
    companion object Factory : BufferFactory<Argb4444Buffer>, CapacityCalculator<Plane1Capacities> {
        ...
        override fun allocate(width: Int, height: Int, cropRect: Rect): Argb4444Buffer {
        ...
        override fun wrap(buffer: ByteBuffer, width: Int, height: Int, cropRect: Rect): Argb4444Buffer {
