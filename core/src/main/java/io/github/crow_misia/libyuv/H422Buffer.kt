...
class H422Buffer private constructor(
    ...
    fun rotate(dst: H422Buffer, rotateMode: RotateMode) {
    ...
    fun scale(dst: H422Buffer, filterMode: FilterMode) {
        Yuv.scaleI422Scale(
            srcY = planeY.buffer, srcStrideY = planeY.rowStride,
            srcU = planeU.buffer, srcStrideU = planeU.rowStride,
            srcV = planeV.buffer, srcStrideV = planeV.rowStride,
    ...
    companion object Factory : BufferFactory<H422Buffer> {
        ...
        fun wrap(planeY: Plane, planeU: Plane, planeV: Plane, width: Int, height: Int): H422Buffer {
            return H422Buffer(
                buffer = null,
                planeY = planeY,
                planeU = planeU,
