...
internal object Yuv {
    ...
    external fun convertARGB1555ToI420(
        srcARGB1555: ByteBuffer,
        srcStrideARGB1555: Int,
        dstY: ByteBuffer,
        dstStrideY: Int,
        dstU: ByteBuffer,
        dstStrideU: Int,
    ...
    external fun convertARGB4444ToI420(
        srcARGB4444: ByteBuffer,
        srcStrideARGB4444: Int,
        dstY: ByteBuffer,
        dstStrideY: Int,
        dstU: ByteBuffer,
        dstStrideU: Int,
    ...
    external fun convertNV21ToARGB(
        srcY: ByteBuffer, srcStrideY: Int, srcVU: ByteBuffer, srcStrideVU: Int,
        dstARGB: ByteBuffer, dstStrideARGB: Int,
        width: Int, height: Int
    )
    ...
    external fun convertI420ToARGB1555(
        ...
        srcV: ByteBuffer,
        srcStrideV: Int,
        dstARGB1555: ByteBuffer,
        dstStrideARGB1555: Int,
        width: Int,
        height: Int
    )
    ...
    external fun convertI420ToARGB4444(
        ...
        srcV: ByteBuffer,
        srcStrideV: Int,
        dstARGB4444: ByteBuffer,
        dstStrideARGB4444: Int,
        width: Int,
        height: Int
    )
    ...
    external fun scaleScalePlane(
        src: ByteBuffer, srcStride: Int, srcWidth: Int, srcHeight: Int,
    ...
    external fun scaleARGBScale(
        srcARGB: ByteBuffer, srcStrideARGB: Int, srcWidth: Int, srcHeight: Int,
    ...
    external fun memcopy(
        dst: Any, dstOffset: Int,
        src: Any, srcLength: Int,
    )
